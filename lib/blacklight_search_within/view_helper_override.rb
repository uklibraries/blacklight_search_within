...
#      return "blacklight_search_within/search_within_panel" if range_config(display_facet.name) and should_show_limit(display_facet.name)
#      super
#    end
#
#    def has_search_within_parameters?(params = params)
#      params[:range] && 
...
#      super || has_search_within_parameters?
#    end
#
#    def query_has_constraints?(params = params)         
#      super || has_search_within_parameters?(params)
#    end
#
